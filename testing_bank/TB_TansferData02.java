...
public class TB_TansferData02 {
	...
	public static void main(String[] args) throws Exception {
		...
		TB_TansferData02 tbDao = new TB_TansferData02();
		tbDao.exeStart(args);
	...
	public void exeStart(String[] args) throws Exception {
		...
		String tableList = "TB_CPI_RADAR,TB_CPI_RADAR_DMS,TB_DECLARATION,TB_DEFINE_CHARACTER,TB_DEFINE_COMPETENCY,TB_DEFINE_CPI,TB_DEFINE_ENGLISH_L,TB_DEFINE_ENGLISH_R,TB_DEFINE_EXAM1024,TB_DEFINE_IQ,TB_DEFINE_WORKSTYLE,TB_DEFINE_WORKVALUE,TB_EXAM,TB_EXAM_DIMENSION,TB_FREE_CALL,TB_IMP_QUESTION,TB_IMP_USER,TB_IMP_VERSION,TB_LANGUAGE,TB_MANAGER,TB_MARQUEE,TB_MODULE_CHARACTER,TB_MODULE_CHARACTER_MDL,TB_MODULE_COMPETENCY,TB_MODULE_COMPETENCY_MDL,TB_MODULE_CPI_B,TB_MODULE_CPI_MDL,TB_MODULE_CPI_PST,TB_MODULE_WORKVALUE,TB_NEWS,TB_NOTICE,TB_POINT,TB_QUESTIONNAIRE,TB_QUESTIONNAIRE_REPLY,TB_QUESTION_CHARACTER,TB_QUESTION_COMPETENCY,TB_QUESTION_CPI,TB_QUESTION_ENGLISH_L";
