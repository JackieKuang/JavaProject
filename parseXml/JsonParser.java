...
public class JsonParser {
	...
	public static void main(String[] args) throws Exception {
		...
		//Output Excel
		WritableWorkbook workbook=Workbook.createWorkbook(new File("C:\\遠東集團Excel_"+dateSrting+".xls"));//創建工作簿
		...
		String jsonString = readerURL.readTextFile("http://www.104.com.tw/i/apis/jobsearch.cfm?role=1,4&fmt=8&area=6001000000&custno=98770235000,97179430000,5714195000,21257316000,3521905000,83416573000,86517096001,36552651000,28435809000,5104840000,33977304000,3522600000,3244509000,36057744000,11332202002,70624227000,23932737000,23928945000,47224065000,53000774000,97311466000&cols=CUSTNO,NAME,JOB,JOB_ADDR_NO_DESCRIPT,MINBINARY_EDU,PERIOD,SALARY_HIGH,SALARY_LOW,WORKTIME,PCSKILL_ALL_DESC,DRIVER,S9,D3,S5,DESCRIPTION&exp=5&exp_all=2&pgsz=500&page=1");
		//String jsonString = readerURL.readTextFile("http://www.104.com.tw/i/apis/jobsearch.cfm?role=1,4&fmt=8&custno=98770235000&cols=CUSTNO,NAME,JOB,JOB_ADDR_NO_DESCRIPT,MINBINARY_EDU,PERIOD,SALARY_HIGH,SALARY_LOW,WORKTIME,PCSKILL_ALL_DESC,DRIVER,S9,D3,S5,DESCRIPTION&exp=5&exp_all=2&pgsz=500&page=1");
		...
		for(int p=1; p<=TOTALPAGE; p++) {
			...
			System.err.println("Page="+p+",TOTALPAGE="+TOTALPAGE);
		}
