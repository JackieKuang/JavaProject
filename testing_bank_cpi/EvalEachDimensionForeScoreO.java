 ...
 * @author jackie
 *
 * �p��3�x�H��¾��ʮ�����i4�B5��PR�ȡBB�ȡBPR�ȡB¾�ȾA�X�׵��G
 * 
 */
...
public class EvalEachDimensionForeScoreO{
	...
	*/
	 ...
	 *
	 */
	public EvalEachDimensionForeScoreO(Connection conn) {
		this.conn = conn;
	}
	 ...
	 * @throws Exception
	 */
	public void setDimensionScore(String bvuId,String positionId, String prPositionId) throws Exception {
			SPArr = new float[questionIdArr.length];	// questionIdArr.length �����ת��
			dimensionScore(bvuId);   //	�p�� SP��
	 ...
	 *  @throws Exception
	 */
	private void dimensionScore(String bvuId) throws Exception{
		PreparedStatement PS1 = null;
		ResultSet RS1 = null;
		
		try{
			String sqlStr = "select * from b2b_vip_answer where bvu_id=?";
			PS1 = conn.prepareStatement(sqlStr);
			PS1.setString(1,bvuId);
			RS1 = PS1.executeQuery();
			
			if(RS1.next()){
				long tempSec = RS1.getTimestamp("create_date").getTime();
				...
				errMassage = "No This bvu_id Number : "+bvuId;
			}
		}catch(Exception ex){
