...
public class EvalEachDimensionScoreO {
	private float[] SPArr;
	private double[] ZArr;
	private int[] PRArr;
	private double[] SN;
	 ...
	 *
	 */
	public EvalEachDimensionScoreO() {} 
	...
	*/
	 ...
	 * @throws Exception
	 */
	private void dimensionScore(Connection conn, String bvuId) throws Exception {
		PreparedStatement PS1 = null;
		ResultSet RS1 = null;
		...
		try {
			...
			if(RS1.next()) {
				...
				throw new Exception("No This bvu_id Number : "+bvuId);
			}
		}
		catch(Exception ex) {
			throw ex;
