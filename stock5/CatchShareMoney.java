	...
	public static void main(String[] args) throws Exception {
		...
		for(int i=0; i<stockNum.length; i++) {
			try {
				...
				String strAll = ru.readTextFile("http://tw.stock.yahoo.com/d/s/company_"+stockNum[i]+".html");
				...
				strSP = strAll.substring(strAll.indexOf("<td align=\"center\" height=\"25\">99</td>"),strAll.indexOf("<td align=\"center\" height=\"25\">93</td>"));
...
//				System.err.println(capital);
				...
				//Insert Data
				query = "insert into stock_share_money(stock_id,year1,date1,money1,date2,money2,money3,money_all,money_total,capital,create_date) "+
						" values(?,?,?,?,?,?,?,?,?,?,now())";
				stmt = conn.prepareStatement(query);
				stmt.setString(1,stockNum[i]);
				stmt.setString(2,year1);
				stmt.setString(3,date2);
				stmt.setString(4,money1);
				stmt.setString(5,date1);
				stmt.setString(6,money2);
				stmt.setString(7,money3);
				stmt.setString(8,money_all);
				stmt.setString(9,money_total);
				stmt.setString(10,capital);
				stmt.executeUpdate();
				stmt.close();
